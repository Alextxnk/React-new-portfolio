         ...
         <div className='container mx-auto h-full'>
            <div className='flex items-center h-full pt-8'>
               ...
               <div className='flex-1 flex flex-col items-center lg:items-start'>
                  <p className='text-lg text-accent mb-[22px]'>Hey. I'm Alex</p>
                  ...
                  <p className='pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam molestias sint eveniet impedit quasi officiis corrupti asperiores eligendi aliquid, ratione aliquam molestiae debitis doloribus? Id possimus dolorum ullam velit sit.</p>
                  <button className='btn btn-md bg-accent hover:bg-accent-hover md:btn-lg transition-all'>Work with me</button>
               </div>
               {/* right side */}
               <div className='hidden lg:flex flex-1 justify-end items-end h-full'>
                  <img src={ProfileImg} alt='ProfileImg' className='max-w-lg' />
               </div>
            </div>
         </div>
      </section>
